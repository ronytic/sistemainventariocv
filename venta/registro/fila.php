...
<tr>
    ...
    <td class="contenedorstock">
        <input type="number" name="c[<?=$f;?>][cantidad]" class="form-control cantidad text-right" rel="<?=$f?>" min="0"><center><span class="badge badge-success stock"  rel="<?=$f?>">0</span></center>
